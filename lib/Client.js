...
class Client extends EventEmitter {
    ...
    * @arg {Object} [options] Eris options (all options are optional, except 'identifyProperties' and 'userAgent')
    ...
    * @arg {Number} [options.defaultImageSize=256] The default size to return user avatars, guild icons, banners, splashes, and group icons. Can be any power of two between 16 and 2048. If the height and width are different, the width will be the value specified, and the height relative to that
    ...
    * @arg {Object} options.identifyProperties Properties which should be sent with identify packet
    ...
    * @arg {Boolean} options.userAgent User agent which should be used for all API requests
    ...
    */
    constructor(token, options) {
        ...
        if(!this.options.identifyProperties) {
            throw new Error("Invalid identify properties");
        }
